...
public class MembershipView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        membershipTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Membership ID", "Tier", "Expiry Date", "Type"
            }
        ) {
        ...
        if (membershipTable.getColumnModel().getColumnCount() > 0) {
            membershipTable.getColumnModel().getColumn(0).setResizable(false);
            membershipTable.getColumnModel().getColumn(1).setResizable(false);
            membershipTable.getColumnModel().getColumn(2).setResizable(false);
            membershipTable.getColumnModel().getColumn(3).setResizable(false);
        }
